...
@implementation CJFilterControl
...
-(id) initWithFrame:(CGRect) frame Titles:(NSArray *) titles{
    if (self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, 70)]) {
        ...
        UIImage *image1 = [UIImage imageNamed:@"round_small"];
        UIImage *image2 = [UIImage imageNamed:@"round_lager"];
        _handler = [UIButton buttonWithType:UIButtonTypeCustom];
        [_handler setFrame:CGRectMake(LEFT_OFFSET, 8, 20, 20)];
        ...
        //        _handler.backgroundColor = [UIColor brownColor];
        //        UIImage *image1 = [UIImage imageNamed:@"round_small"];
        //        UIImage *image2 = [UIImage imageNamed:@"round_lager"];
...
-(NSInteger)getSelectedTitleInPoint:(CGPoint)pnt{
